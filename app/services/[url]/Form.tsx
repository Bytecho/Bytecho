        ...
        <div className='rounded md:rounded-lg lg:rounded-l-none lg:rounded-r-lg bg-surfaceBlue p-[1rem] md:py-[1.5rem] md:px-[4rem] lg:py-[2.5rem] xl:py-[3rem] lg:px-[3.5rem] 2xl:py-[4rem] 2xl:px-[8rem] w-full lg:w-3/5'>
            ...
            {!renderForm && renderSuccessMessage && (
                ...
                >
                    ...
                    />
                    <p className="mt-[1rem] lg:mt-0 text-center text-lg lg:text-xl">Your quote request has been sent. We will get in touch as soon as possible. You can also contact us at <br className="md:hidden" /><a className='text-[#059669]' href="tel:+61414029043"> 0414029043</a>.
                    </p>
                </motion.div>
            )}
