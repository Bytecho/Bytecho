  ...
  return (
    <div className='page'>
        <div className=" pt-[1.25rem] flex flex-col gap-[0.5rem]">
            <h1 className="text-[#F3F4F6] h3 md:text-[1.5rem] md:leading-[1.75rem]">We specialise in <span className="text-greenBrand">Branding, Custom Web Design and Development.</span></h1>
            <p className="text-blue-200 text-[0.875rem] md:text-[1rem] leading-[1.25rem] md:leading-[1.5rem]">Whether you&apos;re starting from scratch or looking to elevate your existing brand, we&apos;ve got the creative edge and the tech-savvy to make it happen.</p>
        </div>
